---
description: >-
  En esta sección construiremos un componente reutilizable. Aprenderás que son
  las props de un componente React, esto es clave para poder reutilizar y
...
Las aplicaciones construidas con React tienen una [arquitectura orientada a componentes.](https://en.wikipedia.org/wiki/Component-based_software_engineering) Esto provee un nivel de abstracción mayor que colabora a que podamos tener muchos componentes reutilizables a lo largo de la aplicación.
...
Si pensamos cómo podríamos estructurar este componente podría tener algo así:
...
Ahora que tenemos nuestro componente reutilizable, hagamos un ejemplo sobre cómo utilizarlo.
